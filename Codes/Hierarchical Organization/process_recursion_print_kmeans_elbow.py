...
from compute_optimal_clusters import compute_optimal_clusters_by_elbow_2
...
def main():
    ...
    optimal_clusters, silhouettes = compute_optimal_clusters_by_elbow_2(embedding_data_umap, max_clusters=max_clusters - 1,
                                                                    min_clusters=2)

    print(f"Optimal number of clusters: {optimal_clusters}")

    kmeans = KMeans(n_clusters=optimal_clusters, init="k-means++", random_state=42)
    kmeans.fit(embedding_data_umap)
    ...
    for cluster_num in range(optimal_clusters):
        ...
        cluster_summary = ask_llm_for_summary_first_inner_glm4(cluster_data, GPU='7')
    ...
    def recursive_clustering(df_input, recursion_level, cluster_tree=None):
        ...
        optimal_clusters_recursion, silhouettes_recursion = compute_optimal_clusters_by_elbow_2(embedding_data_recursion_umap, max_clusters=max_clusters_recursion - 1, min_clusters=2)

        print(f"Optimal number of clusters: {optimal_clusters_recursion}")

        kmeans = KMeans(n_clusters=optimal_clusters_recursion, init="k-means++", random_state=42)
        kmeans.fit(embedding_data_recursion_umap)
        labels_recursion = kmeans.labels_
        ...
        for cluster_num in range(optimal_clusters_recursion):
            ...
            cluster_summary_recursion = ask_llm_for_summary_recursion_inner_glm4(cluster_data_recursion, GPU='7')
