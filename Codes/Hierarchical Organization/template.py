...
"""llama3_chinese_v2 template
"""
register_conv_template(
    Conversation(
        name="llama3_chinese_v2",
        system_prompt="<|begin_of_text|><<SYS>>\nYou are a helpful, excellent and smart assistant. Please respond to the user the language they input, ensuring the language is elegant and fluent. If you don't know the answer to a question, please don't give false information.\n<</SYS>>\n\n",
        messages=[],
        roles=("user", "assistant"),
        # prompt="user {query} assistant",
        prompt="<|start_header_id|>user<|end_header_id|>\n\n{query}<|end_of_text|><|eot_id|><|start_header_id|>assistant<|end_header_id|>\n\n",
        sep="<|eot_id|>",
        # stop_str="<|eot_id|>"
        stop_str="<|end_of_text|>"
    )
...
register_conv_template(
    Conversation(
        ...
        sep="\n",
        # stop_str="<|im_end|>",
        stop_str=["<|im_end|>","<|endoftext|>","```python"],
    )
)
