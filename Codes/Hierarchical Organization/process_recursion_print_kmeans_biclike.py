...
from compute_optimal_clusters import compute_optimal_clusters_by_biclike
...
def main():
    ...
    optimal_clusters, silhouettes = compute_optimal_clusters_by_biclike(embedding_data_umap, max_clusters=max_clusters - 1,
                                                                    min_clusters=2)
    ...
    def recursive_clustering(df_input, recursion_level, cluster_tree=None):
        ...
        optimal_clusters_recursion, silhouettes_recursion = compute_optimal_clusters_by_biclike(embedding_data_recursion_umap, max_clusters=max_clusters_recursion - 1, min_clusters=2)
