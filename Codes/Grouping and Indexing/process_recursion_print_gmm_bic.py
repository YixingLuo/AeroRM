...
from compute_optimal_clusters import compute_optimal_clusters_by_bic
...
def main():
    ...
    optimal_clusters, silhouettes = compute_optimal_clusters_by_bic(embedding_data_umap, max_clusters=max_clusters - 1,
                                                                    min_clusters=2)
    ...
    for cluster_num in range(optimal_clusters):
        ...
        cluster_summary = ask_llm_for_summary_first_inner_glm4(cluster_data, GPU='5')
    ...
    def recursive_clustering(df_input, recursion_level, cluster_tree=None):
        ...
        optimal_clusters_recursion, silhouettes_recursion = compute_optimal_clusters_by_bic(embedding_data_recursion_umap, max_clusters=max_clusters_recursion - 1, min_clusters=2)
        ...
        for cluster_num in range(optimal_clusters_recursion):
            ...
            cluster_summary_recursion = ask_llm_for_summary_recursion_inner_glm4(cluster_data_recursion, GPU='5')
